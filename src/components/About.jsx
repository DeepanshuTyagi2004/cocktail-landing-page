...
function About() {
    useGSAP(() => {
        ...
        aboutTimeline.from(titleSplit.words, {
            opacity: 0, yPercent: 100, ease: "expo.out", stagger: 0.02, duration: 1
        })
            .from(".top-grid, .bottom-grid div", {
                opacity: 0, ease: "power1.inOut", stagger: 0.04, duration: 1
            }, "-=1")
    });
    return (
        <div id="about">
            ...
            <div className="top-grid">
                ...
                <div className="md:col-span-6">
                    <div className="noisy" />
                    <img src="/images/abt2.png" alt="about-img-2"/>
                </div>
                <div className="md:col-span-3">
                    <div className="noisy" />
            ...
            <div className="bottom-grid">
                <div className="md:col-span-8">
                    <div className="noisy" />
                    <img src="/images/abt3.png" alt="about-img-3"/>
                </div>
                <div className="md:col-span-4">
                    <div className="noisy" />
                    <img src="/images/abt4.png" alt="about-img-4"/>
                </div>
            </div>
        </div>
    );
